public class ArvoreBinaria {
	 ...
	 */
	public void inserir(int elemento, String nome, String telefone) throws Exception {
		raiz = inserir(elemento, nome, telefone, raiz);
	}
	 ...
	 * @throws Exception Se o elemento existir.
	 */
	private No inserir(int elemento, String nome, String telefone, No i) throws Exception {
		if (i == null) {
			i = new No(elemento, nome, telefone);
		} else if (elemento < i.elemento) {
			i.esq = inserir(elemento, nome, telefone, i.esq);
		} else if (elemento > i.elemento) {
			i.dir = inserir(elemento, nome, telefone, i.dir);
		} else {
	 ...
	 * @throws Exception Se o elemento existir.
	 */
    public void inserirPai(int elemento, String nome, String telefone) throws Exception {
        if (raiz == null) {
            raiz = new No(elemento, nome, telefone);
        } else if (elemento < raiz.elemento) {
            inserirPai(elemento, nome, telefone, raiz.esq, raiz);
        } else if (elemento > raiz.elemento) {
            inserirPai(elemento, nome, telefone, raiz.dir, raiz);
        } else {
	 ...
	 * @throws Exception Se o elemento existir.
	 */
    private void inserirPai(int elemento, String nome, String telefone, No i, No pai) throws Exception {
        if (i == null) {
            if (elemento < pai.elemento) {
                pai.esq = new No(elemento, nome, telefone);
            } else {
                pai.dir = new No(elemento, nome, telefone);
            }
        } else if (elemento < i.elemento) {
            inserirPai(elemento, nome, telefone, i.esq, i);
        } else if (elemento > i.elemento) {
            inserirPai(elemento, nome, telefone, i.dir, i);
        } else {
            throw new Exception("Erro ao inserirPai!");
        }
    }
